...
-- ============================================================
-- Users (passwords are BCrypt hashed, default password: "password123")
-- ============================================================
-- Admin users
...
-- ============================================================
-- Questions for Test 1: Java Programming Basics
-- ============================================================
...
-- Answer options for Java questions
...
-- ============================================================
-- Questions for Test 2: Database Design Principles
-- ============================================================
INSERT INTO questions (test_id, question_text, question_type, order_num) VALUES
...
-- Answer options for Database questions
INSERT INTO answer_options (question_id, option_text, is_correct, order_num) VALUES
-- Question 1
...
-- ============================================================
-- Questions for Test 3: Web Development Fundamentals
-- ============================================================
INSERT INTO questions (test_id, question_text, question_type, order_num) VALUES
...
-- Answer options for Web Development questions
INSERT INTO answer_options (question_id, option_text, is_correct, order_num) VALUES
-- Question 1
...
-- ============================================================
-- Questions for Test 4: Software Testing Methods
-- ============================================================
INSERT INTO questions (test_id, question_text, question_type, order_num) VALUES
...
-- Answer options for Testing questions
INSERT INTO answer_options (question_id, option_text, is_correct, order_num) VALUES
-- Question 1
...
-- Specialist 1 completed Test 1 (failed first attempt)
...
-- Specialist 4 completed Test 1 (failed)
...
-- SELECT 'Tests:' as info, COUNT(*) FROM tests;
-- SELECT 'Questions:' as info, COUNT(*) FROM questions;
-- SELECT 'Answer Options:' as info, COUNT(*) FROM answer_options;
-- SELECT 'Assignments:' as info, COUNT(*) FROM test_assignments;
-- SELECT 'Results:' as info, COUNT(*) FROM test_results;
